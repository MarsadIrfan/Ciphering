...
def main():
	...
	if hackedMessage != None:
		...
		print("Failed to hack ecryption")
...
def hackVigenere(ciphertext):
	...
	for keyLength in allLikelyKeyLengths:
		if not SILENT_MODE:
			print("Attempting hack with key length %s (%s possible key)..." % (keyLength, NUM_MOST_FREQ_LETTERS**keyLength))
